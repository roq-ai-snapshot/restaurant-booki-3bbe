  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant booking engine: Streamlining your dining experience by allowing customers to reserve tables and enabling staff to manage reservations and menus seamlessly."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant booking engine: Streamlining your dining experience by allowing customers to reserve tables and enabling staff to manage reservations and menus seamlessly.`}
            </Text>
            <Box
